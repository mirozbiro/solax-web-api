...
# ============================================================================
SOLAX_CLIENT_ID = "30238817c9e2459d986d777c9d333a97"
SOLAX_CLIENT_SECRET = "NUyrSAUYfY8timTEo7F2OvxOQPIY3s2gzLg5y-fdaSY"
SOLAX_DEVICE_SN = "H34A10J3655008"  # Your device serial number
...
async def main():
    ...
    device_sn = SOLAX_DEVICE_SN if SOLAX_DEVICE_SN != "H34A10J3655008" else None
